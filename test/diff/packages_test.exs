# defmodule Diff.PackagesTest do
#   use Diff.DataCase
...
#     @valid_attrs %{name: "some name", registry: "some registry", versions_updated_at: "2010-04-17T14:00:00Z"}
#     @update_attrs %{name: "some updated name", registry: "some updated registry", versions_updated_at: "2011-05-18T15:01:01Z"}
...
#       assert package.versions_updated_at == DateTime.from_naive!(~N[2010-04-17T14:00:00Z], "Etc/UTC")
#     end
...
#       assert package.versions_updated_at == DateTime.from_naive!(~N[2011-05-18T15:01:01Z], "Etc/UTC")
#     end
